shinyjs.displayRates = function(params) {
    ...
    districts = params[0];
    newHTML = params[1];
    emptyHTML = '<div><style> .leaflet-control.rate-label { transform: translate(20px,-90px); position: fixed !important; left: 350; text-align: center; padding-left: 10px;  padding-right: 10px;  background: rgba(255,255,255,0.75); font-weight: bold; font-size: 24px; } </style>Mouse over a district to display prevalence</div>';
